...
# Fixing The Private Repository Issue
In the last lab you may have come across an error that prevented your from hosting your private repository website on GitHub pages, the following steps should help you fix this. 

The first thing you need to do, is follow [This Link](https://classroom.github.com/a/AQHUIOKM), this should take you to the GitHub classroom page for the module, which should look similar to the image below.

![Image](Pictures/018.png) 

Choose "Accept this assignment" and GitHub reaction should generate you a link to your new repository. 

![Image](Pictures/019.png) 

Click this link and you will be redirected to your new repository. 

From here, what you need to do is take the repository you created last week, and copy it across to your new repository - there are a few ways you can do this, but for a bit of GitHub pratice we are going to do it on the local machine. 

Go to the local workspace on your machine and use the skills you gained last week to create two folders, one named "OriginalAssignment" and the other "NewAssignment"

You should end up with a folder structure that looks like this:

![Image](Pictures/020.png) 

Open the "OriginalAssignment" folder, and right click and open the terminal. 
...
You should now at this point have two GitHub repositories, one containing your work from last week, and another containing just a "README.md" file.
...
Create a working document in Word for this session and explain what you just did, adding a screenshot to your Pictures folder of your new GitHub classroom repository.
    </div>
</div>
...
Take a screenshot of this window and add it to your pictures folder, and then write an explaination of what you did in your working document.  
    </div>
</div>
...
ake a screenshot of your YAML and add it to your pictures folder, and then write an explaination of what you did in your working document.  
    </div>
</div>
